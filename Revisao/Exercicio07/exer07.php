...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $prazo_finalizacao = intval($_POST['prazo_finalizacao']);
    $atividades_total = intval($_POST['atividades_total']);
    $atividades_desenvolvidas = intval($_POST['atividades_desenvolvidas']);
    $produtividade_diaria = floatval($_POST['produtividade_diaria']);
